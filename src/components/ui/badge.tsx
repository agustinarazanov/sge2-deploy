...
const badgeVariants = cva(
  " text-white inline-flex items-center border text-[10px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
