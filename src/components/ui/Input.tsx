...
export const inputBaseStyle = cn(
  ...
  "px-4 py-[9px] bg-input focus:border-input-active border border-input rounded-md focus:rounded-md hover:border-input-hover text-input-label placeholder:text-input-placeholder",
