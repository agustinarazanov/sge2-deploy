  ...
  return (
    <div className="relative flex w-full flex-col items-center justify-between space-y-3 md:flex-row-reverse md:space-x-1.5 md:space-y-0">
      <div className="relative flex w-full flex-col justify-end space-y-3 sm:basis-1/2 sm:flex-row sm:space-x-2 sm:space-y-0 md:w-auto md:basis-1/3 md:space-y-0">
        <Button color={"ghost"}>
          <Link href={rutaEquipos.href} passHref>
            Equipos
          </Link>
        </Button>
        <Button color={"ghost"}>
          <Link href={rutaEquipos?.subRutas && rutaEquipos.subRutas[1] ? rutaEquipos.subRutas[1].href : ""} passHref>
            Tipos
          </Link>
        </Button>
        <Button color={"ghost"}>
          <Link href={rutaEquipos?.subRutas && rutaEquipos.subRutas[2] ? rutaEquipos.subRutas[2].href : ""} passHref>
            Préstamos
          </Link>
        </Button>
        <Button color={"ghost"}>
          <Link href={rutaEquipos?.subRutas && rutaEquipos.subRutas[3] ? rutaEquipos.subRutas[3].href : ""} passHref>
            Mis préstamos
          </Link>
        </Button>
      </div>
